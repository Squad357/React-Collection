    ...
    <AnimatePresence>
      {isModalOpen && (
        <motion.div
          ...
          className='fixed flex items-center justify-center top-0 left-0 right-0 bottom-0 bg-[#000000db] w-full h-full z-[60]'>
          <motion.div
            ...
            <Cross2Icon
              onClick={handleClose}
              className='absolute top-6 right-[-14px] text-white w-6 h-6 cursor-pointer'
            />
          </motion.div>
        </motion.div>
      )}
